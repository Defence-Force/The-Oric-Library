...
<?php
	...
	if ($page=='contributors')
	{
		...
		$content.= '<li>Geir Pisani';
		$content.= '<li>Hakan Karlsson';
		$content.= '<li>Ivan Savchev';
		$content.= '<li>Jim Groom';
		$content.= '<li>Jonathan Haworth';
		$content.= '<li>Kamel Biskri';
		$content.= '<li>Maxime Croizer (also busy on <a href="http://acpc.me">Amstrad CPC mémoire écrite</a>)';
		$content.= '<li>Mike Brown';
		$content.= '<li>Oric.org';
